                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="index.php" method="POST" id="formulario_pedido">
                                    ...
                                    <fieldset class="border border-black p-3 mb-4 h-100">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-4">
                                                ...
                                                <input type="date" id="data" name="data" class="form-control" value="<?php print date('Y-m-d'); ?>" readonly />
                                            </div>
                                            <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <button type="button" id="limpar_pedido" class="btn btn-outline-secondary w-100 ">
                                        <i class="bi bi-arrow-counterclockwise"></i> Limpar
                                    </button>
                                </div>
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-success w-100" name="salvar_pedido" id="salvar_pedido">
