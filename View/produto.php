            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title" id="modalVerificarProdutoLabel">Verificar Produto</h6>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nome_produto" name="nome_produto" placeholder="Digite o nome do produto" required autocomplete="off" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="largura" class="form-label">Largura (m) *</label>
                                            <input type="text" class="form-control" id="largura" name="largura" placeholder="Informe a largura" required autocomplete="off" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="tipo_produto_verificar" class="form-label">Tipo do Produto *</label>
                                            <div class="input-group">
                                                <input type="hidden" id="id_tipo_hidden_verificar" name="id_tipo_produto" value="" />
                                                <span class="input-group-text"><i class="bi bi-search"></i></span>
                                                <input type="text" class="form-control" id="tipo_produto_verificar" placeholder="Ex: Tecido, Plástico" autocomplete="off" required />
                                                <button type="button" class="btn btn-outline-primary btn-abrir-cadastro-rapido" data-bs-toggle="modal" data-bs-target="#modal_tipo_produto"><i class="bi bi-plus-lg"></i></button>
                                                <div id="resultado_busca_tipo_verificar" class="list-group position-absolute top-100 start-0 w-100 zindex-dropdown shadow" style="max-height:200px; overflow-y:auto; z-index:1050;"></div>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                        ...
                        <form action="index.php" method="POST">
                            <div class="row g-3 mt-2">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="nome_produto_consulta" name="nome_produto" placeholder="Nome do produto" autocomplete="off" />
                                    <br>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text"><i class="bi bi-search"></i></span>
                                        <input type="text" class="form-control" id="tipo_produto_consulta" placeholder="Ex: Tecido, Plástico" autocomplete="off" />
                                        <div id="resultado_busca_tipo_consulta" class="list-group position-absolute top-100 start-0 w-100 zindex-dropdown shadow" style="max-height:200px; overflow-y:auto; z-index:1050;"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div id="resultado_busca_cor_consulta" class="list-group position-absolute top-100 start-0 w-100 zindex-dropdown shadow" style="max-height:200px; overflow-y:auto; z-index:1050;"></div>
                                    </div>
                                    <br>
                                    <label for="id_fornecedor_produto" class="form-label">Fornecedor</label>
                                    <div class="input-group">
                                        ...
                                        <div id="resultado_busca_fornecedor" class="list-group position-absolute top-100 start-0 w-100 zindex-dropdown shadow" style="max-height:200px; overflow-y:auto; z-index:1050;"></div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="modal_tipo_produto" tabindex="-1" aria-labelledby="modalTipoProdutoLabel" aria-hidden="true">
            <div class="modal-dialog modal-default modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="index.php" method="POST" id="formulario_tipo_produto_cadastro">
                            <fieldset class="border border-black p-3 mb-4">
                    ...
                    <div class="modal-body">
                        <form action="index.php" method="POST">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <label for="nome_tipo_produto" class="form-label">Nome do Tipo de Produto</label>
                                    <input type="text" class="form-control" id="nome_tipo_produto" name="nome_tipo_produto" placeholder="Digite o nome do tipo de produto" autocomplete="off" pattern="^[A-Za-zÀ-ÖØ-öø-ÿ\s]+$" title="Somente letras e espaços são permitidos" />
                    ...
                    <div class="modal-body">
                        <form action="index.php" method="POST">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <label for="nome_cor" class="form-label">Nome da Cor</label>
                                    <input type="text" class="form-control" id="nome_cor" name="nome_cor" placeholder="Digite o nome da cor" autocomplete="off" pattern="^[A-Za-zÀ-ÖØ-öø-ÿ\s]+$" title="Somente letras e espaços são permitidos" />
                        ...
                        <form action="index.php" method="POST">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="razao_social_consulta" name="razao_social" placeholder="Digite a razão social" autocomplete="off" />
                        ...
                        <form action="index.php" method="POST" id="formulario_consulta_cnpj">
                            <fieldset class="border border-black p-3 mb-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control cnpj " id="cnpj_consulta" name="cnpj_consulta" placeholder="00.000.000/0000-00" required autocomplete="off" pattern="\d{2}\.\d{3}\.\d{3}/\d{4}-\d{2}" title="Formato esperado: XX.XXX.XXX/XXXX-XX" />
